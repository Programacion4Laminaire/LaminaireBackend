...
namespace CarrierJob.Infrastructure;

public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructureCarrierJob(this IServiceCollection services, ConfigurationManager configuration)
    {
        // Registro del DbContext con SQL Server
        services.AddDbContext<CourierJobDbContext>(options =>
